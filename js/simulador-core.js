...
(function(){
  ...
  Core.interpolate = function(str, variables){ if(typeof str !== 'string') return str; return str.replace(/\{\{\s*([^}]+)\s*\}\}/g, (_,name)=>{
  ...
  Core.processText = function(text, asMarkdown){ if(!asMarkdown) return text; // se delegará a un renderer markdown externo si existe
